        ...
        >
          ...
          >
            ...
            <div class="w-full flex flex-col items-center">
              ...
              <h3 class="font-display text-3xl md:text-4xl text-primary mb-2">
                Rendez-vous sur
              </h3>
              <p class="font-display text-3xl md:text-4xl text-primary">
                notre site
              </p>
            </div>
            ...
            <div class="w-full flex flex-col items-center relative">
              ...
              <div class="relative mb-8 w-full max-w-xs mx-auto space-y-4">
                ...
                >
                  Les migrants aux États-Unis mangent-ils vraiment des chats et
                  des chiens ?
                </div>
                <div
                  class="bg-primary text-white p-4 rounded-2xl rounded-tr-none shadow-lg text-sm text-left ml-auto font-medium animate-float-delayed"
                >
              ...
              <p class="font-display text-3xl md:text-4xl text-primary mb-2">
                dans le chat et
              </p>
              <p class="font-display text-3xl md:text-4xl text-primary">
                obtenez une réponse fiable
              </p>
            </div>
          </div>
        </div>
